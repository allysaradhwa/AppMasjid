            ...
            <div class="container mt-3">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="tambahpengeluaran.php"><button class="btn warntb float-right text-light btn-sm text-sm-center"><i class="fa fa-plus fa-sm">  Tambah data</i></button></a>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <thead>
                    <tr>
                    <th class="warntb text-center" scope="col" style="width: 40px;">No</th>
                    ...
                    <th class="warntb text-center" scope="col">Nama Admin</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
