            ...
            <div class="container mt-3">
                <div class="row">
                    <div class="col-md-6">
                        <h5 class="text-dark"><i class="fa fa-minus fa-lg mr-2"></i>Pengeluaran Kas Masjid</h5>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="alert alert-danger" role="alert">
                            Total Pengeluaran=Rp.<?= $total['totalpengeluaran']?>,00
                        </div>
                        <?php endforeach?>
                        <?= Flasher::flash()?>
                    </div>
                ...
                <thead>
                    ...
                    <th class="warntb text-center" scope="col" style="width:60px;">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
